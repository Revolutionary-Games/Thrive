...
starter_microbes = {
    Default = {
        ...
        organelles = {
            ...
            {name="mitochondrion",q=1,r=-1, rotation=0},
            {name="vacuole",q=0,r=-1, rotation=0},
            {name="vacuole",q=-1,r=0, rotation=0},
            {name="flagellum",q=0,r=1, rotation=0},
            {name="flagellum",q=-1,r=1, rotation=0},
            {name="flagellum",q=1,r=0, rotation=0},
            {name="flagellum",q=0,r=-2, rotation=0},
            {name="flagellum",q=-1,r=-1, rotation=0},
    ...
    Speedy = {
        ...
        organelles = {
            {name="nucleus", q=0, r=0, rotation=0},
            {name="mitochondrion", q=0, r=-1, rotation=0},
    ...
    Plankton = {
        ...
        organelles = {
            ...
            {name="vacuole", q=1, r=0, rotation=0},
            {name="vacuole", q=0, r=-1, rotation=0},
            {name="vacuole", q=-1, r=1, rotation=0},
            {name="mitochondrion", q=-1, r=0, rotation=0},
            {name="mitochondrion", q=0, r=1, rotation=0},
            {name="mitochondrion", q=1,r=-1, rotation=0},
            ...
            {name="vacuole", q=0, r=2, rotation=0},
            {name="vacuole", q=2, r=-2, rotation=0},
            {name="chloroplast", q=1, r=1, rotation=0},
            {name="chloroplast", q=1,r=-2, rotation=0},
            {name="chloroplast", q=-2, r=1, rotation=0},
            {name="chloroplast", q=-1,r=-1, rotation=0},
            {name="chloroplast", q=-1, r=2, rotation=0},
            {name="chloroplast", q=2,r=-1, rotation=0},
            {name="flagellum", q=3, r=0, rotation=0},
            {name="flagellum", q=0,r=-3, rotation=0},
            {name="flagellum", q=-3, r=3, rotation=0},
            {name="flagellum", q=-3, r=0, rotation=0},
            {name="flagellum", q=0, r=3, rotation=0},
            {name="flagellum", q=3,r=-3, rotation=0},
            {name="chloroplast", q=-1, r=3, rotation=0},
            {name="chloroplast", q=3,r=-2, rotation=0},
            {name="chloroplast", q=1,r=-3, rotation=0},
            {name="chloroplast", q=-3, r=2, rotation=0},
        },
    },
    Algae = {
        ...
        organelles = {
            ...
            {name="mitochondrion", q=0, r=1, rotation=0},
            {name="vacuole", q=0, r=-1, rotation=0},
            {name="chloroplast", q=1, r=0, rotation=0},
            {name="chloroplast", q=-1, r=0, rotation=0},
            {name="chloroplast", q=1, r=-1, rotation=0},
            {name="chloroplast", q=-1, r=1, rotation=0},
        },
    ...
    Poisonous = {
        ...
        organelles = {
            ...
            {name="vacuole", q=0, r=-2, rotation=0},
            {name="vacuole", q=0, r=2, rotation=0},
            {name="chloroplast", q=0, r=-3, rotation=0},
            {name="chloroplast", q=0, r=3, rotation=0},
            {name="oxytoxy", q=1, r=0, rotation=0},
            {name="oxytoxy", q=-1, r=0, rotation=0},
            {name="oxytoxy", q=1, r=-1, rotation=0},
            {name="oxytoxy", q=-1, r=1, rotation=0},
    ...
    Predator = {
        ...
        organelles = {
            ...
            {name="flagellum", q=0, r=-1, rotation=0},
            {name="flagellum", q=0, r=-2, rotation=0},
            {name="oxytoxy", q=0, r=1, rotation=0},
        },
    },
    Gluttonous = {
        ...
        organelles = {
            ...
            {name="mitochondrion", q=-2,  r=1, rotation=0},
            {name="mitochondrion", q=-1, r=-1, rotation=0},
            {name="mitochondrion", q=-1,  r=0, rotation=0},
            {name="mitochondrion", q=-1,  r=1, rotation=0},
            {name="mitochondrion", q=-1,  r=2, rotation=0},
            {name="mitochondrion", q=0, r=-1, rotation=0},
            {name="mitochondrion", q=0, r=-2, rotation=0},
            {name="mitochondrion", q=1, r=-2, rotation=0},
            {name="mitochondrion", q=1, r=-1, rotation=0},
            {name="mitochondrion", q=1, r=0, rotation=0},
            {name="mitochondrion", q=1, r=1, rotation=0},
            ...
            {name="vacuole", q=-3, r=5, rotation=0},
            {name="vacuole", q=-2, r=0, rotation=0},
            {name="vacuole", q=-2, r=2, rotation=0},
