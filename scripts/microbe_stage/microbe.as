...
class MicrobeSystem{
    ...
    void storeCompound(ObjectID microbeEntity, CompoundId compoundId, double amount, bool bandwidthLimited){
        auto microbeComponent = getComponent(microbeEntity, MicrobeComponent);
    ...
    // We'll probably need a rotation for this, although maybe it should be done in c++ where sets are a thing?
    ...
    void damage(ObjectID microbeEntity, uint amount, string damageType){
    ...
    ObjectID createMicrobeEntity(string name, bool aiControlled, string speciesName, bool in_editor){
