...
internal static class KeyNames
{
    ...
    private static void Keys()
    {
        ...
        TranslationServer.Translate("NOBREAKSPACE");
        ...
        TranslationServer.Translate("BACKTAB");
        ...
        TranslationServer.Translate("SHIFT");
        TranslationServer.Translate("CONTROL");
        TranslationServer.Translate("META");
        TranslationServer.Translate("ALT");
        TranslationServer.Translate("CAPSLOCK");
        TranslationServer.Translate("NUMLOCK");
        TranslationServer.Translate("SCROLLLOCK");
        TranslationServer.Translate("F1");
        TranslationServer.Translate("F2");
        TranslationServer.Translate("F3");
        TranslationServer.Translate("F4");
        TranslationServer.Translate("F5");
        TranslationServer.Translate("F6");
        TranslationServer.Translate("F7");
        TranslationServer.Translate("F8");
        TranslationServer.Translate("F9");
        TranslationServer.Translate("F10");
        TranslationServer.Translate("F11");
        TranslationServer.Translate("F12");
        TranslationServer.Translate("F13");
        TranslationServer.Translate("F14");
        TranslationServer.Translate("F15");
        TranslationServer.Translate("F16");
