...
///   The command name. This is the keyword the user submits in the console to invoke the
///   method.
/// </param>
/// <param name="isCheat">Whether this command should report cheats used to the game.</param>
/// <param name="helpText">
///   A synthetic optional help text string. This string will be shown when the "help" command is
