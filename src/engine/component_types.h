...
//! \note Don't forget to use componentTypeConvert(...) when these are used to make
//! them the right type. Also for the base Component class should be constructed like this:
//! "Leviathan::Component(TYPE)" instead of duplicating the enum value there to avoid errors
