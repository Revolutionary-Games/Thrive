...
public struct MulticellularSpeciesMember : IArchivableComponent
{
    ...
    ///   <see cref="MulticellularCellType"/> in the <see cref="MulticellularSpecies.ModifiableCells"/>
    /// </summary>
    ...
    {
        if (cellBodyPlanIndex < 0 || cellBodyPlanIndex >= species.ModifiableCells.Count)
