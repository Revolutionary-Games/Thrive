...
public class MulticellularSpecies : Species, IReadOnlyMulticellularSpecies, ISimulationPhotographable
{
    ...
    /// <summary>
    ///   Player-species option for forcing the player to manually lay out their cells.
    /// </summary>
    /// <remarks>
    ///   <para>
    ///     This is intentionally not copied on cloning as AI species do not do a manual layout.
    ///   </para>
    /// </remarks>
    public bool UsesManualPlayerLayout { get; set; }

    /// <summary>
    ///   The 'original' colony layout, from which the simulated one (<see cref="GameplayCells"/>) is generated by
    ///   the editor. This can be "missing" in which case the editor layout is automatically re-generated from the
    ///   gameplay cell data.
    /// </summary>
