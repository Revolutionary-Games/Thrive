...
public interface IMod
{
    ...
    /// <summary>
    ///   Called when it is safe for mods to attach nodes (i.e. initial Node setup has finished and new children can
...
public class HarmonyLoadException : Exception
{
    public HarmonyLoadException(Exception inner) : base("Harmony operation failed", inner)
    {
    }
}
