...
public class GameProperties : IArchivable
{
    ...
    public static GameProperties StartNewAwareStageGame(WorldGenerationSettings settings)
    {
        ...
        for (int r = 0; r > -1000; --r)
        {
            ...
            if (!brainType.ReadonlyOrganelles.CanPlaceAndIsTouching(template, false, workMemory1, workMemory2, false))
                continue;

            brainType.ReadonlyOrganelles.AddFast(template, workMemory1, workMemory2);
    ...
    private static MicrobeSpecies MakePlayerOrganellesMakeSenseForMulticellular(GameProperties game)
    {
        ...
        playerSpecies.ModifiableOrganelles.AddFast(new OrganelleTemplate(
            simulationParameters.GetOrganelleType("nucleus"),
        ...
        playerSpecies.ModifiableOrganelles.AddFast(new OrganelleTemplate(
            simulationParameters.GetOrganelleType("bindingAgent"),
