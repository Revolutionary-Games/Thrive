    ...
    private void Step()
    {
        switch (state)
        {
            ...
            case State.Screenshot:
            {
                ...
                SaveStatusOverlay.Instance.ShowMessage(TranslationServer.Translate("SAVE_SAVING"),
                    Mathf.Inf);
            ...
            case State.Finished:
            {
                ...
                else
                {
                    ...
                    SaveStatusOverlay.Instance.ShowError(TranslationServer.Translate("SAVE_ERROR"),
                        message, exception);
                }
