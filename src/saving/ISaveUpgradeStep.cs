...
public static class SaveUpgradeSteps
{
    ...
    private static Dictionary<string, ISaveUpgradeStep> InitializeSaveUpgradeSteps()
    {
        ...
        return new Dictionary<string, ISaveUpgradeStep>
        {
            ...
            { "0.7.0.0-alpha", new UpgradeJustVersionNumber("0.7.0.0-rc1") },
            { "0.6.7.1", new UpgradeJustVersionNumber("0.7.0.0-rc1") },
            ...
            { "0.8.1.0-rc1", new UpgradeJustVersionNumber("0.8.1.0") },
            ...
            { "0.8.2.0-alpha", new UpgradeJustVersionNumber("0.8.2.1") },
        };
    }
}
