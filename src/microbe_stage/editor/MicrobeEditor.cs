...
public class MicrobeEditor : NodeWithInput, ILoadableGameState, IGodotEarlyNodeResolve
{
    ...
    /// </summary>
    [JsonProperty]
    private ActionHistory<MicrobeEditorAction> history = null!;
    ...
    public void OnFinishEditing()
    {
        ...
        if (targetPatch != null)
        {
            GD.Print("MicrobeEditor: applying player move to patch: ", TranslationServer.Translate(targetPatch.Name.ToString()));
