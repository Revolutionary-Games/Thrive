...
public partial class MembraneWaterRipple : Node
{
    ...
    [Export]
    public Color WaterColor = new Color(0.0f, 0.0f, 0.0f, 0.02f);
    ...
    // State tracking
    private float lastScaleCheckTime = 0.0f;
    private float lastCheckedMembraneRadius = 0.0f;
    ...
    public override void _Ready()
    {
        ...
        lastMovementTime = (float)Time.GetTicksMsec() / 1000.0f;
        CreateWaterPlane();
    ...
    public override void _PhysicsProcess(double delta)
    {
        ...
        try
        {
            ...
            UpdateMovementParameters(delta);
        }
        catch (Exception e)
        {
...
#pragma warning restore CS8600, CS8602
    ...
    private void UpdateMovementParameters(double delta)
    {
        try
        {
            ...
            if (timeSinceLastMovement > 0.01f) // Only update after minimum time to avoid jitter
            {
                previousPosition = lastPosition;
                movement = currentPos - lastPosition;
