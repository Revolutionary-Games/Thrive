...
public partial class MicrobeAISystem : BaseSystem<World, float>, ISpeciesMemberLocationData
{
        ...
        ref Health health, float strain, Random random)
    {
        ...
        if (compounds.GetCompoundAmount(Compound.Hydrogensulfide) >
            compounds.GetCapacityForCompound(Compound.Radiation) * organelles.HydrogenSulfideProtectionFraction)
        {
