    ...
    Planet::toJSON() const
{
   ...
   Json::Value habitabilityScoresJ(Json::ValueType::arrayValue);
    for(auto habitability : orbitingStar.habitabilityScores)
        habitabilityScoresJ.append(habitability);

    result["habitabilityScores"] = habitabilityScoresJ;
