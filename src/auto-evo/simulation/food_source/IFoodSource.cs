public interface IFoodSource
{
    ...
    /// <returns>A float to represent score. Scores are only compared against other scores from the same FoodSource, so different
    ///  implementations do not need to worry about scale.</returns>
