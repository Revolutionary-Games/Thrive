        ...
        Random random, BiomeConditions biomeToConsider)
    {
        ...
        switch (attribute)
        {
            case BehaviorAttribute.Activity:
                newSpecies.ModifiableBehaviour.Activity = Math.Max(Math.Min(newSpecies.Behaviour.Activity + change,
                    Constants.MAX_SPECIES_ACTIVITY), 0);
                break;
            case BehaviorAttribute.Aggression:
                newSpecies.ModifiableBehaviour.Aggression = Math.Max(Math.Min(newSpecies.Behaviour.Aggression + change,
                    Constants.MAX_SPECIES_AGGRESSION), 0);
                break;
            case BehaviorAttribute.Opportunism:
                newSpecies.ModifiableBehaviour.Opportunism = Math.Max(Math.Min(newSpecies.Behaviour.Opportunism + change,
            ...
            case BehaviorAttribute.Focus:
                newSpecies.ModifiableBehaviour.Focus = Math.Max(Math.Min(newSpecies.Behaviour.Focus + change,
