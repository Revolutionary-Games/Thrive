...
public class PredationEffectivenessPressure : SelectionPressure
{
    ...
    public PredationEffectivenessPressure(Species prey, float weight) :
        base(weight, [
            ...
            new UpgradeToxinOrganelle(organelle => organelle.HasAgentVacuoleComponent, "oxytoxy", "both"),
            new UpgradeToxinOrganelle(organelle => organelle.HasAgentVacuoleComponent, "none", "both"),
            new UpgradeToxinOrganelle(organelle => organelle.HasAgentVacuoleComponent, "macrolide", "both"),
