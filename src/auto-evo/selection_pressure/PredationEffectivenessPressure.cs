...
public class PredationEffectivenessPressure : SelectionPressure
{
    ...
    public PredationEffectivenessPressure(Species prey, float weight) :
        base(weight, [
            ...
            new UpgradeOrganelle(organelle => organelle.HasLysosomeComponent, new LysosomeUpgrades(new Enzyme("chitinase"))),
            new UpgradeOrganelle(organelle => organelle.HasLysosomeComponent, new LysosomeUpgrades(new Enzyme("cellulase"))),
