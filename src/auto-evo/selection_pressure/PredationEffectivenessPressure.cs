...
public class PredationEffectivenessPressure : SelectionPressure
{
    ...
    public PredationEffectivenessPressure(Species prey, float weight) :
        base(weight, [
            ...
            new UpgradeToxinOrganelle(organelle => organelle.HasAgentVacuoleComponent, "oxytoxy",
                MutationDirection.Both),
            new UpgradeToxinOrganelle(organelle => organelle.HasAgentVacuoleComponent, "none",
                MutationDirection.Both),
            new UpgradeToxinOrganelle(organelle => organelle.HasAgentVacuoleComponent, "macrolide",
                MutationDirection.Both),
            new UpgradeToxinOrganelle(organelle => organelle.HasAgentVacuoleComponent, "channel",
                MutationDirection.Both),
            new UpgradeToxinOrganelle(organelle => organelle.HasAgentVacuoleComponent,
                "oxygen_inhibitor", MutationDirection.Both),
