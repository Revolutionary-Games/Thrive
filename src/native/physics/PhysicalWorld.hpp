...
public:
    ...
    // Note: there used to be activation parameters for bodies on impulse and velocity set, however activation is now
    // mandatory in Jolt, so the parameter is now always true and thus removed from the API
