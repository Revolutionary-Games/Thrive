...
#pragma warning restore CA2213
    ...
    public static MicrobeEditor ReadFromArchive(ISArchiveReader reader, ushort version, int referenceId)
    {
        ...
        var instance = SceneLoadHelpers.LoadAndInstantiate<MicrobeEditor>(
            "res://src/microbe_stage/editor/MicrobeEditor.tscn",
            "loading microbe editor from save");

        if (instance == null)
            throw new InvalidOperationException("Failed to instantiate microbe editor scene when loading from save");
