...
#pragma warning restore CA2213
    ...
    public override void MoveToEditor()
    {
        ...
        if (Player.Has<MulticellularSpeciesMember>())
        {
            ...
            var editor = SceneLoadHelpers.LoadAndInstantiate<MulticellularEditor>(
                "res://src/multicellular_stage/editor/MulticellularEditor.tscn",
                "entering multicellular editor from microbe stage");

            if (editor == null)
                throw new InvalidOperationException("Failed to instantiate multicellular editor scene");
        ...
        else
        {
            ...
            var editor = SceneLoadHelpers.LoadAndInstantiate<MicrobeEditor>(
                "res://src/microbe_stage/editor/MicrobeEditor.tscn",
                "entering microbe editor from microbe stage");

            if (editor == null)
                throw new InvalidOperationException("Failed to instantiate microbe editor scene");
