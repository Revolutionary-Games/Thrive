...
public class NativeLibs
{
    ...
    private static readonly HttpClient PlainHttpClient = new();
        ...
        PrecompiledObjectVersionDTO precompiledData, CancellationToken cancellationToken)
    {
        ...
        for (int i = 0; i < 10; ++i)
        {
            ...
            // ReSharper disable once MethodSupportsCancellation
            response = await PlainHttpClient.PutAsync(uploadResponse.UploadUrl,
        ...
        string version, PrecompiledTag tags, string targetFile, CancellationToken cancellationToken)
    {
        ...
        for (int i = 0; i < 10; ++i)
        {
            ...
            try
            {
                ...
                using var download = await PlainHttpClient.GetAsync(downloadUrl, completion,
                    cancellationToken);
