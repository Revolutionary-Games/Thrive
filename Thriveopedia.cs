...
#pragma warning restore CA2213
    ...
    private void AddPage(string name, IThriveopediaPage? page = null)
    {
        ...
        if (page == null)
        {
            var scenePath = $"res://src/thriveopedia/pages/Thriveopedia{name}Page.tscn";
            page = SceneLoadHelpers.LoadAndInstantiate<IThriveopediaPage>(scenePath, $"adding Thriveopedia page {name}");
